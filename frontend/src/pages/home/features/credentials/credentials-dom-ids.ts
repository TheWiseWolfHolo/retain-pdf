...
export const CREDENTIAL_DOM_IDS = {
  ...
  browser: {
    ...
    providerProfileId: "browser-provider-profile-id",
    targetLanguage: "browser-target-language",
    rateLimitQps: "browser-rate-limit-qps",
    rateLimitRpm: "browser-rate-limit-rpm",
