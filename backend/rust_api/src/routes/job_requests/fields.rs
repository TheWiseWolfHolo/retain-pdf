...
pub(super) fn apply_multipart_request_field(
    ...
    match name {
        ...
        "custom_ocr_api_key" => request.ocr.custom_ocr_api_key = value.to_string(),
        "custom_ocr_base_url" => request.ocr.custom_ocr_base_url = value.to_string(),
        "custom_ocr_model" => request.ocr.custom_ocr_model = value.to_string(),
