...
pub struct PublicOcrInput {
    ...
    pub custom_ocr_api_key_configured: bool,
...
pub fn public_request_payload(spec: &ResolvedJobSpec) -> PublicResolvedJobSpec {
    PublicResolvedJobSpec {
        ...
        ocr: PublicOcrInput {
            ...
            custom_ocr_api_key_configured: !spec.ocr.custom_ocr_api_key.trim().is_empty(),
            custom_ocr_base_url: spec.ocr.custom_ocr_base_url.clone(),
            custom_ocr_model: spec.ocr.custom_ocr_model.clone(),
